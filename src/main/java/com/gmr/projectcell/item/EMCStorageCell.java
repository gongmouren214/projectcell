package com.gmr.projectcell.item;
...
public class EMCStorageCell extends Item {
   ...
   public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand usedHand) {
      ...
      if (level.isClientSide) {
         ...
         itemstack.set(ProjectCell.OWNER_UUID, player.getUUID());
         ...
         boolean current = itemstack.getOrDefault(ProjectCell.NBT_FILTER, false);
         itemstack.set(ProjectCell.NBT_FILTER, !current);
   ...
   public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
      ...
      boolean nbtFilter = stack.getOrDefault(ProjectCell.NBT_FILTER, false);
      ...
      if (stack.has(ProjectCell.OWNER_UUID)) {
